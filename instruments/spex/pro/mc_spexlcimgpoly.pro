...
;
; CALLING SEQUENCE:
;     result = mc_spexlcimgpoly(x,c,CANCEL=cancel)
;    
; INPUTS:
...
;     2009-08-11 - Renamed mc_imgpoly, M. Cushing, Institute for
;                  Astronomy, UH
;     2014-08-06 - Renamed mc_spexlcimgpoly, M. Cushing, University of Toledo
;-
function mc_spexlcimgpoly,x,c,CANCEL=cancel

cancel = 0

if n_params() lt 2 then begin

    print, 'Syntax - result = mc_spexlcimgpoly(x,c,CANCEL=cancel)'
    cancel = 1
    return, -1

endif

cancel = mc_cpar('mc_spexlcimgpoly',x,1,'X',[2,3,4,5],2)
if cancel then return,-1
cancel = mc_cpar('mc_spexlcimgpoly',c,2,'C',[2,3,4,5],3)
if cancel then return,-1
