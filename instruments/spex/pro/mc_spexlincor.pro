...
;
; CALLING SEQUENCE:
;     mc_spexlincor,image,itime,slowcnts,ndr,coefficients,$
;                   [saturation,saturated],CANCEL=cancel   
;
; INPUTS:
...
;     2009-03-11 - Renamed mc_spexlincor
;-
function mc_spexlincor,image,itime,slowcnts,ndr,coefficients,saturation,$
...
if n_params() lt 5 then begin
    ...
    print, 'Syntax - result = mc_spexlincor(image,itime,slowcnts,ndr,$'
...
cancel = mc_cpar('mc_spexlincor',image,1,'Image',[2,3,4,5],2)
if cancel then return,-1
cancel = mc_cpar('mc_spexlincor',itime,2,'Itime',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_spexlincor',slowcnts,3,'Slowcnts',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_spexlincor',ndr,4,'Ndr',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_spexlincor',coefficients,5,'Coefficients',[2,3,4,5],3)
if cancel then return,-1
...
c_pedimage = pedimage*(c0/mc_spexlcimgpoly(pedimage, coefficients) > 1.0)
c_finimage = finimage*(c0/mc_spexlcimgpoly(finimage, coefficients) > 1.0)
