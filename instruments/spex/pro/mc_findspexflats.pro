...
;
; CALLING SEQUENCE:
;     result = mc_findspexflats(files,MASK=mask,CANCEL=cancel)
;
; INPUTS:
...
;-
function mc_findspexflats,files,MASK=mask,CANCEL=cancel
...
;  Check parameters
  ...
  if n_params() lt 1 then begin
     ...
     print, 'Syntax -  result = mc_findspexflats(files,MASK=mask,CANCEL=cancel)'
     cancel = 1
     return, -1
     
  endif
  cancel = mc_cpar('mc_findspexflats',files,1,'Files',7 ,[0,1])
