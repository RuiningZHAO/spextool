...
;
; CALLING SEQUENCE:
;     result = mc_findspexarcs(files,MASK=mask,AB=ab,CANCEL=cancel)
;
; INPUTS:
...
;-
function mc_findspexarcs,files,MASK=mask,AB=ab,CANCEL=cancel
...
;  Check parameters
  ...
  if n_elements(arc) eq 0 then return, -1 else return, arc
