...
; CALLING SEQUENCE:
;     mc_mkspexlog
;     mc_mkspexlog,ifilename,ofilename,CANCEL=cancel
;
; INPUTS:
;     None
;
...
;-
pro mc_mkspexlog,ifilename,ofilename,CANCEL=cancel
...
cancel = mc_cpar('mklog',ifilename,1,'Ifilename',7,0)
if cancel then return
cancel = mc_cpar('mklog',ofilename,2,'Ofilename',7,0)
if cancel then return
...
readcol,ifilename,names,FORMAT='A',/SILENT
...
for i = 0, nfiles-1 do begin
    ...
    result    = mc_gethdrinfo(hdr,keywords,STRING=string)
    info[i,*] = string
