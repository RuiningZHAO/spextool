...
;
; CALLING SEQUENCE:
;     result = mc_tracetoap1d(edgecoeffs,tracecoeffs,norders,naps,slith_arc,$'
...
;     2009-03-11 - Renamed mc_tracetoap.
;-
function mc_tracetoap1d,edgecoeffs,tracecoeffs,norders,naps,slith_arc,xranges,$
...
;  Check parameters
  ...
  if n_params() lt 8 then begin
     ...
     cancel = 1
     print, 'Syntax - result = mc_tracetoap1d(edgecoeffs,tracecoeffs,norders,$'
     print, '                                 naps,slith_arc,xranges,step,$'
     print, '                                 nrows,WID=wid,CANCEL=cancel)'
    return, -1

endif

cancel = mc_cpar('mc_tracetoap1d',edgecoeffs,1,'Edgecoeffs',[2,3,4,5],[2,3])
if cancel then return,-1
cancel = mc_cpar('mc_tracetoap1d',tracecoeffs,2,'Tracecoeffs',[2,3,4,5],[2,3])
if cancel then return,-1
cancel = mc_cpar('mc_tracetoap1d',norders,3,'Norders',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_tracetoap1d',naps,4,'Naps',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_tracetoap1d',slith_arc,5,'Slith_arc',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_tracetoap1d',xranges,6,'Xranges',[2,3,4,5],[1,2])
if cancel then return,-1
cancel = mc_cpar('mc_tracetoap1d',step,7,'Step',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_tracetoap1d',nrows,8,'Nrows',[2,3,4,5],0)
if cancel then return,-1
