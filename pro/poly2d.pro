...
cancel = mc_cpar('poly2d',x,1,'X',[2,3,4,5],[0,1])
if cancel then return,-1
cancel = mc_cpar('poly2d',y,2,'Y',[2,3,4,5],[0,1])
if cancel then return,-1
cancel = mc_cpar('poly2d',xorder,3,'Xorder',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('poly2d',yorder,4,'Yorder',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('poly2d',coeffs,5,'Coeffs',[2,3,4,5],1)
if cancel then return,-1
