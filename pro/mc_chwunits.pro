...
cancel = mc_cpar('mc_chwunits',wave,1,'Wave',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('mc_chwunits',iwunit,2,'Iwunit',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_chwunits',owunit,3,'Owunit',[2,3,4,5],0)
if cancel then return,-1
