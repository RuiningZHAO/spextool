...
if keyword_set(SPEC1) then begin
    ...
    mc_tabinv,state.d.x1,state.r.guesspos1,idx
    ...
    mc_tabinv,xwin,state.r.guesspos1,idx
...
if keyword_set(SPEC2) then begin
    ...
    mc_tabinv,state.d.x2,state.r.guesspos2,idx
    ...
    mc_tabinv,xwin,state.r.guesspos2,idx
...
cancel = mc_cpar('xgetoffset',x1,1,'X1',[2,3,4,5],1)
if cancel then return
cancel = mc_cpar('xgetoffset',y1,2,'Y1',[2,3,4,5],1)
if cancel then return
cancel = mc_cpar('xgetoffset',x2,3,'X2',[2,3,4,5],1)
if cancel then return
cancel = mc_cpar('xgetoffset',y2,4,'Y2',[2,3,4,5],1)
if cancel then return
...
cgcentertlb,state.w.xgetoffset_base
