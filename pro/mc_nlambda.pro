...
;
; CALLING SEQUENCE:
;     result = mc_nlambda(lambda,pressure,temp,[water],CANCEL=cancel)
;
; INPUTS:
...
;-
function mc_nlambda,lambda,pressure,temp,water,CANCEL=cancel
...
if n_params() lt 3 then begin
     ...
     cancel = 1
     print, 'Syntax - result = mc_nlambda(lambda,pressure,temp,[water],$'
     print, '                          CANCEL=cancel)'
     return, -1

endif
cancel = mc_cpar('mc_nlambda',lambda,1,'Lambda',[2,3,4,5],[0,1])
if cancel then return,-1
cancel = mc_cpar('mc_nlambda',pressure,2,'Pressure',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_nlambda',temp,3,'Temp',[2,3,4,5],0)
if cancel then return,-1

if n_params() eq 4 then cancel = mc_cpar('mc_nlambda',water,4,'Water',[2,3,4,5],0)
if cancel then return,-1
