...
cancel = mc_cpar('poly_fit2d',x,1,'X',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('poly_fit2d',y,2,'Y',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('poly_fit2d',z,3,'Z',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('poly_fit2d',xorder,4,'Xorder',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('poly_fit2d',yorder,5,'Yorder',[2,3,4,5],0)
if cancel then return,-1
