...
;
; CALLING SEQUENCE:
;     result = mc_getspecscale(stack,IDX=idx,CANCEL=cancel)
;
; INPUTS:
...
;-
function mc_getspecscale,stack,IDX=idx,CANCEL=cancel
...
;  Check parameters
  ...
  if n_params() lt 1 then begin
     ...
     print, 'Syntax -  result = mc_getspecscale(stack,IDX=idx,CANCEL=cancel)'
     cancel = 1
     return, -1
     
  endif
  cancel = mc_cpar('mc_getspecscale',stack,1,'Stack',[2,3,4,5],2)
...
;  Compute median of the stack
     ...
     mc_medcomb,stack,refspec,CANCEL=cancel
     if cancel then return,-1
