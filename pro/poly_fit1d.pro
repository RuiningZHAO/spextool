...
cancel = mc_cpar('poly_fit1d',x,1,'X',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('poly_fit2d',y,2,'Y',[2,3,4,5,12,13,14,15],1)
if cancel then return,-1
cancel = mc_cpar('poly_fit2d',order,3,'Order',[2,3,4,5],0)
if cancel then return,-1
...
if order eq 0 then begin
    ...
    mc_meancomb,yy,coeffs,var,DATAVAR=yvar
    coeffs = [coeffs,0.]
