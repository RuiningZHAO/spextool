...
function mc_extpsspec,image,var,wavecal,edgecoeffs,tracecoeffs,norders,$
                      ...
                      PSBGINFO=PSBGINFO,XSBGINFO=xsbginfo,BDPXMK=bdpxmk, $
...
;  Create the slit and psf mask
        ...
        if debug and x[j] ge debugxrange[0] and $
...
;  Debug plotter
           ...
           if debug and debugfndbdpx then begin
...
;  Store the results
     ...
     for k = 0,naps-1 do begin
        ...
        array = [[owave[nonan]],[ofspec[nonan,k]],[oespec[nonan,k]]]
