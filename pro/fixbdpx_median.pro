...
cancel = mc_cpar('fxbdpx',image,1,'Image',[2,3,4,5],2)
if cancel then return,-1
cancel = mc_cpar('fxbdpx',mask,2,'Mask',[1,2,3,4,5],2)
if cancel then return,-1
cancel = mc_cpar('fxbdpx',edgecoeffs,3,'Edgecoeffs',[2,3,4,5],[2,3])
if cancel then return,-1
cancel = mc_cpar('fxbdpx',norders,4,'Norders',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('fxbdpx',xranges,5,'Xranges',[2,3,4,5],[1,2])
if cancel then return,-1
cancel = mc_cpar('fxbdpx',window,6,'Window',[2,3,4,5],0)
if cancel then return,-1
