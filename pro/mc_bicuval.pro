...
;
; CALLING SEQUENCE:
;     result = mc_bicuval(z,dy1,dy2,dy12,xl,xu,yl,yu,x,y,CANCEL=cancel)
;
; INPUTS:
;
...
;-
function mc_bicuval,z,dz1,dz2,dz12,xl,xu,yl,yu,x,y,CANCEL=cancel
...
if n_params() lt 10 then begin
    ...
    print, 'Syntax - result = mc_bicuval(z,dz1,dz2,dz12,xl,xu,yl,yu,x,y,$'
    print, '                             CANCEL=cancel'
    cancel = 1
    return, -1

endif
cancel = mc_cpar('mc_bicuval',z,1,'Z',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',dz1,2,'Dz1',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',dz2,3,'Dz2',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',dz12,4,'Dz12',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',xl,5,'Xl',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',xu,6,'Xu',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',yl,7,'Yl',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',yu,8,'Yu',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',x,9,'X',[2,3,4,5],[0,1,2])
if cancel then return,-1
cancel = mc_cpar('mc_bicuval',x,10,'Y',[2,3,4,5],[0,1,2])
if cancel then return,-1

c = mc_bicucoeffs(z,dz1,dz2,dz12,(xu-xl),(yu-yl))
IF cancel THEN return,-1
