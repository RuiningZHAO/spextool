...
;
; CALLING SEQUENCE:
;     mc_medcomb,data,med,var,MASK=mask,MAD=mad,UPDATE=update,$
...
;-
pro mc_medcomb,data,med,var,MASK=mask,MAD=mad,UPDATE=update, $
               WIDGET_ID=widget_id,CANCEL=cancel
...
;  Check parameters
  ...
  if n_params() lt 1 then begin
     ...
     print, 'Syntax - mc_mecomb,data,med,war,MASK=mask,MAD=mad,UPDATE=update,$'
     print, '                   WIDGET_ID=widget_id,CANCEL=cancel'
     cancel = 1
     return
     
  endif
  cancel = mc_cpar('mc_medcomb',data,1,'Data',[2,3,4,5],[1,2,3])
