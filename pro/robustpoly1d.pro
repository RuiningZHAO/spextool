...
cancel = mc_cpar('robustpoly1d',x,1,'X',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('robustpoly1d',y,2,'Y',[2,3,4,5,12,13,14,15],1)
if cancel then return,-1
cancel = mc_cpar('robustpoly1d',order,3,'Order',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('robustpoly1d',thresh,4,'Thresh',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('robustpoly1d',eps,5,'Eps',[2,3,4,5],0)
if cancel then return,-1
