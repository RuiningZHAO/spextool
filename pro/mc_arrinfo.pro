...
;
; CALLING SEQUENCE:
;     mc_arrinfo,array,ndimen,dimen,ndat,min,max,type,CANCEL=cancel
;
; INPUTS:
...
;-
pro mc_arrinfo,array,ndimen,dimen,ndat,min,max,type,CANCEL=cancel
...
if n_params() lt 1 then begin
    ...
    print, 'Syntax - mc_arrinfo,array,ndimen,dimen,ndat,min,max,type,$'
    print, '                    CANCEL=cancel'
    cancel = 1
    return
