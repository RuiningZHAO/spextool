...
;                           OGOODBAD=ogoodbad,COVAR=covar,RMS=rms,$
...
cancel = mc_cpar('robustpoly2d',x,1,'X',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('robustpoly2d',y,2,'Y',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('robustpoly2d',z,3,'Z',[2,3,4,5],1)
if cancel then return,-1
cancel = mc_cpar('robustpoly2d',xorder,4,'Xorder',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('robustpoly2d',yorder,5,'Yorder',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('robustpoly2d',thresh,6,'Thresh',[2,3,4,5],0)
if cancel then return,-1
cancel = mc_cpar('robustpoly2d',eps,7,'Eps',[2,3,4,5],0)
if cancel then return,-1
