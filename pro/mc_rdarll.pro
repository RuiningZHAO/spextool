...
;
; PURPOSE:
;     Reads the argon line list and prunes it into memory.
;
; CATEGORY:
;     Spectroscopy
;
...
;     2008-08-01 - Renamed mc_rdarll.
;-
pro mc_rdarll,filename,lines,types,WRANGE=wrange,RES=res,THRESH=thresh,$
              CANCEL=cancel
...
;  Check parameters
  ...
  if n_params() lt 1 then begin
     ...
     print, 'Syntax - mc_rdarll,filename,lines,types,WRANGE=wrange,RES=res,$'
     print, '                   THRESH=thresh,CANCEL=cancel'
     cancel = 1
     return
     
  endif
  cancel = mc_cpar('mc_rdarll',filename,1,'Filename',7, 0)
  if cancel then return
  
;  Read entire file.
  
  readcol,filename,lines,types,FORMAT='D,A',/SILENT
