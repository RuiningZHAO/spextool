...
cancel = mc_cpar('mc_splittext',text,'Text',1,7,0)
if cancel then return, -1
cancel = mc_cpar('mc_splittext',length,'Length',2,[2,3],0)
if cancel then return, -1
