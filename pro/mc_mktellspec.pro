...
pro mc_mktellspec,std_wave,std_flux,std_error,std_mag,std_bminv,kernel,scales,$
                  wvega,fvega,cfvega,cf2vega,vshift,tellcor,tellcor_error, $
                  scvega,CANCEL=cancel
...
;  Check parameters
  ...
  if n_params() lt 12 then begin
     ...
     print, '                     std_bminv,kernel,scales,wvega,fcvega,$'
     print, '                     fc2vega,vshift,tellcor,tellcor_error,$'
     print, '                     scvega,CANCEL=cancel'
     cancel = 1
     return
  ...
  if cancel then return
  cancel = mc_cpar('mc_mktellspec',scales,7,'Scales',[1,2,3,4,5],1)
  if cancel then return
  cancel = mc_cpar('mc_mktellspec',wvega,8,'Wvega',[1,2,3,4,5],1)
  if cancel then return
  cancel = mc_cpar('mc_mktellspec',cfvega,9,'Cfvega',[1,2,3,4,5],1)
  if cancel then return
  cancel = mc_cpar('mc_mktellspec',cf2vega,10,'Cf2vega',[1,2,3,4,5],1)
  if cancel then return
  cancel = mc_cpar('mc_mktellspec',vshift,11,'Vshift',[1,2,3,4,5],0)
  if cancel then return
