...
;
; CALLING SEQUENCE:
;     result = mc_cpath(path,WIDGET_ID=widget_id,CANCEL=cancel)
;
; INPUTS:
...
;-
function mc_cpath,path,WIDGET_ID=widget_id,CANCEL=cancel
...
if n_params() lt 1 then begin
    ...
    print, 'Syntax -  result = mc_cpath(path,WIDGET_ID=widget_id,CANCEL=cancel)'
    cancel = 1
    return, -1
    
 endif
cancel = mc_cpar('mc_cpath',path,1,'Path',7,0)
